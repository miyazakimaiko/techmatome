...
export default async function getVerificationTemplates(email: string): 
  ...
  const text = `
    ...
    このメールに「OK」と返信していただきますと、自動的に登録完了となります。
    件名はそのまま（「登録を完了してください」が件名に含まれた状態）で、本文に「OK」と記入し返信してください。
  `
                                  ...
                                  <tr>
                                    <td class="pad">
                                      <div style="color:#222222;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:180%;text-align:left;mso-line-height-alt:28.8px;">
                                        <p style="margin: 0;"><strong>Techまとめ</strong>にご登録いただきありがとうございます！このメールに「OK」と返信していただきますと、自動的に登録完了となります。件名はそのまま（「登録を完了してください」が件名に含まれた状態）で、本文に「OK」と記入し返信してください。</p>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
